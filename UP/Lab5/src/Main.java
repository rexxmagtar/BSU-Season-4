				...
				switch (p[0].getIndex(p[1])) {
					case 0:
						if (p[1].getIndex(p[2]) == 0) { // ScreenGraphicsTablets
							...
							filepath = "Audio\\Aucustic\\Edifier\\"
									+ DynamicTree.c1_1.getChildAt(
									p[2].getIndex(p[3])).toString();
						}
						if (p[1].getIndex(p[2]) == 1) { // UnscreenGraphicsTablets

							filepath = "Audio\\Aucustic\\Microlab\\"
									+ DynamicTree.c1_2.getChildAt(
									p[2].getIndex(p[3])).toString();
						}
						break;
					case 1:
						if (p[1].getIndex(p[2]) == 0) {

							filepath = "Audio\\CD\\AC_DC\\"
									+ DynamicTree.c2_1.getChildAt(
									p[2].getIndex(p[3])).toString();
						}
						if (p[1].getIndex(p[2]) == 1) {

							filepath = "Audio\\CD\\LMFAO\\"
					...
					case 2: // Keyboards
						if (p[1].getIndex(p[2]) == 0) {
							...
							filepath = "Audio\\Guitars\\Classic\\"
									+ DynamicTree.c3_1.getChildAt(
									p[2].getIndex(p[3])).toString();
						}
						if (p[1].getIndex(p[2]) == 1) {

							filepath = "Audio\\Guitars\\Electric\\"
					...
					case 3: // Microphones
						if (p[1].getIndex(p[2]) == 0) {
							...
							filepath = "Audio\\Player\\Cowon\\"
									+ DynamicTree.c4_1.getChildAt(
									p[2].getIndex(p[3])).toString();
						}
						if (p[1].getIndex(p[2]) == 1) {

							filepath = "Audio\\Player\\Walkman\\"
