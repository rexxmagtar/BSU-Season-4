...
public class NewJPanelBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        ...
        beanDescriptor.setDisplayName ( "Custom  panel" );
        beanDescriptor.setShortDescription ( "Contains 2 radiobuttons and one normal button" );//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_keyToPress = 48;
    private static final int PROPERTY_l = 49;
    private static final int PROPERTY_layout = 50;
    private static final int PROPERTY_lightweight = 51;
    private static final int PROPERTY_LMSG = 52;
    private static final int PROPERTY_locale = 53;
    private static final int PROPERTY_location = 54;
    ...
    private static final int PROPERTY_preferredSize = 68;
    private static final int PROPERTY_preferredSizeSet = 69;
    private static final int PROPERTY_propertyChangeListeners = 70;
    private static final int PROPERTY_r1 = 71;
    private static final int PROPERTY_r1MSG = 72;
    private static final int PROPERTY_r2 = 73;
    private static final int PROPERTY_r2MSG = 74;
    private static final int PROPERTY_sampleProperty = 75;
    private static final int PROPERTY_showing = 76;
    private static final int PROPERTY_size = 77;
    ...
    private static final int PROPERTY_width = 83;
    private static final int PROPERTY_x = 84;
    private static final int PROPERTY_y = 85;

    // Property array 
    /*lazy PropertyDescriptor*/
    private static PropertyDescriptor[] getPdescriptor(){
        PropertyDescriptor[] properties = new PropertyDescriptor[86];
        ...
        try {
            ...
            properties[PROPERTY_b].setPreferred ( true );
            properties[PROPERTY_b].setDisplayName ( "Button color" );
            properties[PROPERTY_b].setShortDescription ( "Describes main button's color" );
            properties[PROPERTY_b].setPropertyEditorClass ( ButtonPropertyEditor.class );
            ...
            properties[PROPERTY_BMSG].setPreferred ( true );
            properties[PROPERTY_BMSG].setDisplayName ( "Button label" );
            properties[PROPERTY_BMSG].setShortDescription ( "Text of main buttons label" );
            properties[PROPERTY_BMSG].setPropertyEditorClass ( ButtonTextPropertyEditor.class );
            ...
            properties[PROPERTY_keyToPress] = new PropertyDescriptor ( "keyToPress", bsu.fpmi.educational_practice.NewJPanel.class, "getKeyToPress", "setKeyToPress" ); // NOI18N
            properties[PROPERTY_keyToPress].setPreferred ( true );
            properties[PROPERTY_keyToPress].setDisplayName ( "Event trigger key" );
            properties[PROPERTY_keyToPress].setShortDescription ( "Key to press to tirgger event" );
            properties[PROPERTY_keyToPress].setPropertyEditorClass ( KeyPropertyEditor.class );
            properties[PROPERTY_l] = new PropertyDescriptor ( "l", bsu.fpmi.educational_practice.NewJPanel.class, "getL", "setL" ); // NOI18N
            properties[PROPERTY_l].setPreferred ( true );
            properties[PROPERTY_l].setDisplayName ( "Panel color" );
            properties[PROPERTY_l].setPropertyEditorClass ( RadioPropertyEditor.class );
            ...
            properties[PROPERTY_LMSG].setPreferred ( true );
            properties[PROPERTY_LMSG].setDisplayName ( "Panel text" );
            properties[PROPERTY_LMSG].setShortDescription ( "Text to display on panel" );
            properties[PROPERTY_LMSG].setPropertyEditorClass ( PanelTextPropertyEditor.class );
            ...
            properties[PROPERTY_r1].setPreferred ( true );
            properties[PROPERTY_r1].setDisplayName ( "Radio button1 color" );
            properties[PROPERTY_r1].setShortDescription ( "Color of radiobutton1 background" );
            properties[PROPERTY_r1].setPropertyEditorClass ( RadioPropertyEditor.class );
            ...
            properties[PROPERTY_r1MSG].setPreferred ( true );
            properties[PROPERTY_r1MSG].setDisplayName ( "Radiobutton1 label" );
            properties[PROPERTY_r1MSG].setShortDescription ( "Label on left side from radiobutton1" );
            properties[PROPERTY_r1MSG].setPropertyEditorClass ( RadioTextPropertyEditor.class );
            properties[PROPERTY_r2] = new PropertyDescriptor ( "r2", bsu.fpmi.educational_practice.NewJPanel.class, "getR2", "setR2" ); // NOI18N
            properties[PROPERTY_r2].setPreferred ( true );
            properties[PROPERTY_r2].setDisplayName ( "Radio button2 color" );
            properties[PROPERTY_r2].setShortDescription ( "Color of radiobutton2 background" );
            properties[PROPERTY_r2].setPropertyEditorClass ( RadioPropertyEditor.class );
            ...
            properties[PROPERTY_r2MSG].setPreferred ( true );
            properties[PROPERTY_r2MSG].setDisplayName ( "Radiobutton2 label" );
            properties[PROPERTY_r2MSG].setShortDescription ( "Label on left side from radiobutton2" );
            properties[PROPERTY_r2MSG].setPropertyEditorClass ( RadioTextPropertyEditor.class );
