...
public class GameManager {
    ...
    public static boolean isDraw(String playerName){
         if(GameRooms.containsKey(gameKeyForPlayer(playerName))){

             return GameRooms.get(gameKeyForPlayer(playerName)).isDraw;
         }
    ...
    public static boolean gameFinishedForUser(String playerName){
        try {
            if(GameRooms.get(gameKeyForPlayer(playerName)).gameFinished()){
                return true;
            }
            return false;
        }
